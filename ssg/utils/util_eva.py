...
def evaluate_topk_single_prediction(gts, pds, k=-1):
    ...
    for obj in range(size_o):
        if 0 == gts[obj]:
            class0_gt.append(gts[obj])
            class0_pd.append(pds[obj])
        if 1 == gts[obj]:
            class1_gt.append(gts[obj])
            class1_pd.append(pds[obj])
        if 2 == gts[obj]:
            class2_gt.append(gts[obj])
            class2_pd.append(pds[obj])
        if 3 == gts[obj]:
            class3_gt.append(gts[obj])
            class3_pd.append(pds[obj])
        if 4 == gts[obj]:
            class4_gt.append(gts[obj])
            class4_pd.append(pds[obj])
        if 5 == gts[obj]:
            class5_gt.append(gts[obj])
            class5_pd.append(pds[obj])
        if 6 == gts[obj]:
            class6_gt.append(gts[obj])
            class6_pd.append(pds[obj])
        if 7 == gts[obj]:
            class7_gt.append(gts[obj])
            class7_pd.append(pds[obj])
