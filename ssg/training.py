...
class Trainer():
    def __init__(self, cfg, model_trainer: BaseTrainer,  # node_cls_names, edge_cls_names,
        ...
        self.Confusion_Memory_Block = Confusion_Memory_Block()
        self.all_features = []
        self.all_labels = []
    ...
    def fit(self, **args):
        ...
        for epoch in pbar:
            ...
            # break
        '''train finished, val finished, save val features'''
        self.Confusion_Memory_Block.save_features(mode='val')
    ...
    def train(self, train_loader, val_loader, epoch_it, it_start, **args):
        ...
        for data in pbar:
            ...
            # print("len(self.all_labels){}".format(len(all_labels)))
            
            logs = self.model_trainer.train_step(data, self.Confusion_Memory_Block, all_features, all_labels, it)
